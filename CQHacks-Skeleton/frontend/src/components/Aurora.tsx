...
export default function Aurora({
  ...
  useEffect(() => {
    ...
    /* Opaque backing avoids a white flash when the canvas is removed or repainted. */
    gl.canvas.style.backgroundColor = "#050508";
    ...
    const initialStops = propsRef.current.colorStops;
